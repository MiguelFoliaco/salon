...
export const Banner = ({ code = 'default', size }: Props) => {
    return (
        <div style={size} className='w-full h-[360px] sm:h-[460px] lg:h-[560px] overflow-hidden relative'>
            {/* Background Image */}
            <Image
                src={defaultURL}
            ...
            {/* Dark Overlay */}
            <div className='absolute inset-0 bg-linear-to-r from-neutral/80 via-neutral/60 to-transparent' />
